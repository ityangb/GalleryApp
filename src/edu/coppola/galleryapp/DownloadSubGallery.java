...
public class DownloadSubGallery extends AsyncTask<Void, Long, Boolean> {
	...
	private final static String IMAGE_FILE_NAME = "_dbgallery_temp_.png";

	public DownloadSubGallery(Context context, DropboxAPI<?> api,
			String dropboxPath) {
	...
	protected Boolean doInBackground(Void... params) {
		try {
			...
			Log.v("MIKE", dirent.fileName());
			for (Entry e : dirent.contents) {
				Log.v("MIKE", e.fileName());
			...
			for (Entry ent : thumbs) {
				...
				ImageCache.putImage(path, mDrawable);
